...
@objc public class DATAStack: NSObject {
    ...
    internal var modelName = ""

    internal var modelBundle = Bundle.main

    private var model: NSManagedObjectModel

    internal var containerURL = URL.directoryURL()
    ...
    internal var _persistentStoreCoordinator: NSPersistentStoreCoordinator?
